import {
  ...
  xt as inject,
  zt as onUnmounted,
} from './vue.runtime.esm-bundler-BV65mu-J.js';
...
function useFetch(url, ...args) {
  ...
  watch([refetch, toRef(url)], ([refetch$1]) => refetch$1 && execute(), {
    deep: true,
  });
  const shell = {
...
function useTimeAgo(time, options = {}) {
  ...
  const timeAgo = computed(() =>
    formatTimeAgo(new Date(toValue(time)), options, toValue(now$1))
  );
  if (exposeControls)
    return {
      timeAgo,
...
function useTimeAgoIntl(time, options = {}) {
  ...
  const result = computed(() =>
    getTimeAgoIntlResult(new Date(toValue(time)), options, toValue(now$1))
  );
...
export {
  ...
  throttleFilter as Ai,
  useScreenOrientation as An,
  createInjectionState as Ar,
  useEventSource as At,
  onLongPress as B,
  tryOnMounted as Bi,
  useStepper as Bn,
  formatDate as Br,
  ...
  watchPausable as Ca,
  refDefault as Ci,
  usePreferredReducedMotion as Cn,
  computedWithControl as Cr,
  useElementBounding as Ct,
  defaultWindow as D,
  whenever as Da,
  set as Di,
  useRefHistory as Dn,
  createEventHook as Dr,
  useElementVisibility as Dt,
  defaultNavigator as E,
  watchWithFilter as Ea,
  refWithControl as Ei,
  useRafFn as En,
  controlledRef as Er,
  useElementSize as Et,
  onElementRemoval as F,
  toReactive as Fi,
  useSessionStorage as Fn,
  debounceFilter as Fr,
  useFileSystemAccess as Ft,
  transition as G,
  useArrayEvery as Gi,
  useSwipe as Gn,
  identity as Gr,
  useIntersectionObserver as Gt,
  provideSSRWidth as H,
  tryOnUnmounted as Hi,
  useStorageAsync as Hn,
  getLifeCycleTarget as Hr,
  useIdle as Ht,
  onKeyDown as I,
  toRef as Ii,
  useShare as In,
  ...
  useFocus as It,
  useAnimate as J,
  useArrayFindIndex as Ji,
  useTextSelection as Jn,
  injectLocal as Jr,
  useMagicKeys as Jt,
  unrefElement as K,
  useArrayFilter as Ki,
  useTemplateRefsList as Kn,
  ignorableWatch as Kr,
  useKeyModifier as Kt,
  onKeyPressed as L,
  toRefs as Li,
  useSorted as Ln,
  debouncedWatch as Lr,
  useFocusWithin as Lt,
  getSSRHandler as M,
  throttledWatch as Mi,
  useScriptTag as Mn,
  createRef as Mr,
  useFavicon as Mt,
  ...
  timestamp as Ni,
  useScroll as Nn,
  createSharedComposable as Nr,
  useFetch as Nt,
  executeTransition as O,
  syncRef as Oi,
  useResizeObserver as On,
  createFilterWrapper as Or,
  useEventBus as Ot,
  onClickOutside as P,
  toArray as Pi,
  useScrollLock as Pn,
  createSingletonPromise as Pr,
  useFileDialog as Pt,
  useBattery as Q,
  useArrayMap as Qi,
  useTimeAgoIntl as Qn,
  isDefined as Qr,
  useMemoize as Qt,
  onKeyStroke as R,
  tryOnBeforeMount as Ri,
  useSpeechRecognition as Rn,
  eagerComputed as Rr,
  useFps as Rt,
  createUnrefFn as S,
  watchOnce as Sa,
  refDebounced as Si,
  usePreferredLanguages as Sn,
  computedEager as Sr,
  useDropZone as St,
  defaultLocation as T,
  watchTriggerable as Ta,
  refThrottled as Ti,
  usePrevious as Tn,
  controlledComputed as Tr,
  useElementHover as Tt,
  setSSRHandler as U,
  until as Ui,
  useStyleTag as Un,
  hasOwn as Ur,
  useImage as Ut,
  onStartTyping as V,
  tryOnScopeDispose as Vi,
  useStorage as Vn,
  get as Vr,
  useGeolocation as Vt,
  templateRef as W,
  useArrayDifference as Wi,
  useSupported as Wn,
  hyphenate as Wr,
  useInfiniteScroll as Wt,
  useAsyncState as X,
  useArrayIncludes as Xi,
  useThrottledRefHistory as Xn,
  isClient as Xr,
  useMediaControls as Xt,
  useAsyncQueue as Y,
  useArrayFindLast as Yi,
  useTextareaAutosize as Yn,
  invoke as Yr,
  useManualRefHistory as Yt,
  useBase64 as Z,
  useArrayJoin as Zi,
  useTimeAgo as Zn,
  isDef as Zr,
  ...
  computedAsync as _,
  watchAtMost as _a,
  reactifyObject as _i,
  usePointerLock as _n,
  assert as _r,
  useDevicePixelRatio as _t,
  breakpointsAntDesign as a,
  useDebounceFn as aa,
  notNullish as ai,
  useNavigatorLanguage as an,
  useVModel as ar,
  useClipboardItems as at,
  createReusableTemplate as b,
  watchIgnorable as ba,
  reactivePick as bi,
  usePreferredContrast as bn,
  camelize as br,
  useDocumentVisibility as bt,
  breakpointsMasterCss as c,
  useLastChanged as ca,
  objectOmit as ci,
  useObjectUrl as cn,
  useVirtualList as cr,
  ...
  usePointer as gn,
  useWindowSize as gr,
  useDeviceOrientation as gt,
  breakpointsVuetifyV3 as h,
  useToggle as ha,
  rand as hi,
  usePermission as hn,
  useWindowScroll as hr,
  useDeviceMotion as ht,
  asyncComputed as i,
  useDebounce as ia,
  normalizeDate as ii,
  useMutationObserver as in,
  useUserMedia as ir,
  useClipboard as it,
  formatTimeAgoIntlParts as j,
  throttledRef as ji,
  useScreenSafeArea as jn,
  createReactiveFn as jr,
  useEyeDropper as jt,
  formatTimeAgo as k,
  syncRefs as ki,
  useSSRWidth as kn,
  createGlobalState as kr,
  useEventListener as kt,
  breakpointsPrimeFlex as l,
  useThrottle as la,
  objectPick as li,
  useOffsetPagination as ln,
  useWakeLock as lr,
  useCountdown as lt,
  breakpointsVuetifyV2 as m,
  useToString as ma,
  pxValue as mi,
  usePerformanceObserver as mn,
  useWindowFocus as mr,
  useDebouncedRefHistory as mt,
  StorageSerializers as n,
  useCounter as na,
  makeDestructurable as ni,
  useMouseInElement as nn,
  useTransition as nr,
  ...
  useToNumber as pa,
  provideLocal as pi,
  useParentElement as pn,
  useWebWorkerFn as pr,
  useDark as pt,
  useActiveElement as q,
  useArrayFind as qi,
  useTextDirection as qn,
  increaseWithUnit as qr,
  useLocalStorage as qt,
  TransitionPresets as r,
  useDateFormat as ra,
  noop as ri,
  useMousePressed as rn,
  useUrlSearchParams as rr,
  useCached as rt,
  ...
  useThrottleFn as ua,
  pausableFilter as ui,
  useOnline as un,
  useWebNotification as ur,
  useCssVar as ut,
  computedInject as v,
  watchDebounced as va,
  reactiveComputed as vi,
  usePointerSwipe as vn,
  autoResetRef as vr,
  useDevicesList as vt,
  defaultDocument as w,
  watchThrottled as wa,
  refManualReset as wi,
  usePreferredReducedTransparency as wn,
  containsProp as wr,
  useElementByPoint as wt,
  createTemplatePromise as x,
  watchImmediate as xa,
  refAutoReset as xi,
  usePreferredDark as xn,
  clamp as xr,
  useDraggable as xt,
  createFetch as y,
  watchDeep as ya,
  reactiveOmit as yi,
  usePreferredColorScheme as yn,
  bypassFilter as yr,
  useDisplayMedia as yt,
  onKeyUp as z,
  tryOnBeforeUnmount as zi,
  useSpeechSynthesis as zn,
  extendRef as zr,
  useFullscreen as zt,
};
//# sourceMappingURL=dist-CATH44te.js.map
