...
describe('SaveQueryDialog', () => {
  ...
  describe('rendering', () => {
    it('should render dialog when open', () => {
      ...
      expect(screen.getByPlaceholderText('e.g., User Statistics Query')).toBeInTheDocument();
    });
  ...
  describe('form fields', () => {
    it('should populate name from initialData', () => {
      ...
      const nameInput = screen.getByPlaceholderText('e.g., User Statistics Query');
    ...
    it('should populate description from initialData', () => {
      ...
      const descriptionInput = screen.getByPlaceholderText('What does this query do?');
  ...
  describe('new collection creation', () => {
    ...
    it('should hide new collection form when cancelled', async () => {
      ...
      expect(screen.queryByPlaceholderText('e.g., Reports')).not.toBeInTheDocument();
    });
  });
