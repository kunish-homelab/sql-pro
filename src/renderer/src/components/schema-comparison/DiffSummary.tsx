...
import type { SchemaComparisonResult, DiffType } from '../../../../shared/types';
...
export function DiffSummary({ comparisonResult, className }: DiffSummaryProps) {
  ...
  const counts = useMemo(() => {
    ...
    comparisonResult.tableDiffs.forEach((tableDiff) => {
      ...
      tableDiff.triggerDiffs?.forEach((triggerDiff) => {
        ...
        else if (triggerDiff.diffType === 'modified') result.triggers.modified++;
      });
    });
  ...
  return (
    <Card className={cn('overflow-hidden', className)}>
      <CardHeader className="cursor-pointer pb-3" onClick={toggleSummaryExpanded}>
      ...
      {isExpanded && (
        <CardContent className="space-y-4 pt-0">
          ...
          <SummarySection
            ...
            onClickCount={(changeType) => handleSectionClick('tables', changeType)}
          />
          ...
          <SummarySection
            ...
            onClickCount={(changeType) => handleSectionClick('columns', changeType)}
          />
          ...
          <SummarySection
            ...
            onClickCount={(changeType) => handleSectionClick('indexes', changeType)}
          />
          ...
          <SummarySection
            ...
            onClickCount={(changeType) => handleSectionClick('triggers', changeType)}
          />
        </CardContent>
      )}
    </Card>
      ...
      <div className="grid grid-cols-3 gap-2">
        ...
        {counts.added > 0 && (
          <Button
            ...
            className="hover:bg-green-100 dark:hover:bg-green-950 h-auto flex-col items-start gap-1 p-2"
        ...
        {counts.removed > 0 && (
          <Button
            ...
            className="hover:bg-red-100 dark:hover:bg-red-950 h-auto flex-col items-start gap-1 p-2"
        ...
        {counts.modified > 0 && (
          <Button
            ...
            className="hover:bg-amber-100 dark:hover:bg-amber-950 h-auto flex-col items-start gap-1 p-2"
