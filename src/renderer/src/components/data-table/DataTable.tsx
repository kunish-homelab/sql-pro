...
import { useTableCore, TableRowData } from './hooks/useTableCore';
import { useVirtualRows } from './hooks/useVirtualRows';
import { useTableEditing } from './hooks/useTableEditing';
import { TableHeader } from './TableHeader';
import { TableBody } from './TableBody';
import type { ColumnSchema, SortState, PendingChange, AggregationType } from '@/types/database';
  ...
  function DataTable(
    ...
    return (
      <div
        ref={containerRef}
        className={cn(
          'relative flex flex-col overflow-auto bg-background outline-none',
