...
mcp__flow -
  nexus__agent_spawn({ type: 'coordinator', name: 'Project Manager' });
...
mcp__flow -
  nexus__agent_spawn({ type: 'researcher', name: 'Primary Researcher' });
mcp__flow -
  nexus__agent_spawn({ type: 'researcher', name: 'Secondary Researcher' });
